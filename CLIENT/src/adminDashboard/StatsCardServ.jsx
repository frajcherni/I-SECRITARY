...
const StatsCardServ = ({ icon, bgColor, title, amount, percentage, percentageColor, onClick,isActive,handleOpenModal}) => {
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-blue-gray-50 p-4">
        <p className="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600" onClick={()=>{if(isActive)handleOpenModal();}}>
          <strong className={percentageColor}>{percentage}</strong>&nbsp;
